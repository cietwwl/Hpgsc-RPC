...
import org.hdl.hpgsc.remoting.dispatcher.ChannelHandlers;
...
public class NettyClient extends AbstractClient {
	...
	public NettyClient(Configuration conf, ChannelHandler handler, Codec codec) throws RemotingException {
		super(conf, wrapChannelHandler(conf,handler),codec);
	}
	
	protected static ChannelHandler wrapChannelHandler(Configuration conf, ChannelHandler handler){
	...
	@Override
	public org.hdl.hpgsc.remoting.Channel getChannel() {
