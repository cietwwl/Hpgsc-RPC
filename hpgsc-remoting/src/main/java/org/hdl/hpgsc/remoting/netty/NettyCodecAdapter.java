...
import org.hdl.hpgsc.remoting.CodecException;
...
final class NettyCodecAdapter {
    ...
    private final org.hdl.hpgsc.remoting.ChannelHandler handler;

    public NettyCodecAdapter(Configuration conf,Codec codec, org.hdl.hpgsc.remoting.ChannelHandler handler) {
        this.codec = codec;
        this.conf = conf;
