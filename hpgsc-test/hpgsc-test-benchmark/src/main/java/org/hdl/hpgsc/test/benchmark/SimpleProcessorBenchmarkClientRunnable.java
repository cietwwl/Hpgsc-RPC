...
public class SimpleProcessorBenchmarkClientRunnable implements ClientRunnable {
    ...
    private void runJavaAndHessian() {
        while (running) {
        	RequestObject requestObject = new RequestObject(requestSize);
            ...
            try {
                ...
                response = clientFactory.get(targetIP, targetPort, rpcTimeout, clientNums).syncRequest(100,requestObject, ResponseObject.class);
