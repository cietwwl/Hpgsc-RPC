...
public abstract class AbstractClientRunnable implements ClientRunnable {
    ...
    private static final Logger LOGGER             = LoggerFactory.getLogger(AbstractClientRunnable.class);
    ...
    protected ExchangeClientFactory clientFactory = new ExchangeClientFactory();
    ...
    public AbstractClientRunnable(String targetIP, int targetPort, int clientNums, int rpcTimeout,CyclicBarrier barrier, CountDownLatch latch, long startTime, long endTime){
    ...
    private void runJavaAndHessian() {
        while (running) {
            ...
            try {
                Object result = invoke(clientFactory); 
    ...
    public abstract Object invoke(ExchangeClientFactory clientFactory) throws Exception;
