...
public class RpcBenchmarkClient extends AbstractBenchmarkClient {
    ...
    public ClientRunnable getClientRunnable(String targetIP, int targetPort, int clientNums, int rpcTimeout,
        ...
        Class[] parameterTypes = new Class[] { String.class, int.class, int.class, int.class, CyclicBarrier.class, CountDownLatch.class, long.class, long.class};
        Object[] parameters = new Object[] {targetIP, targetPort, clientNums, rpcTimeout, barrier, latch, startTime,endTime};
        
        Constructor<?> constructor = Class.forName(runnable).getConstructor(parameterTypes);
        
        ClientRunnable clientRunnable = (ClientRunnable) constructor.newInstance(parameters);
